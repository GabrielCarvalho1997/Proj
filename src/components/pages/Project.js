...
function Project() {
  // Cria nova uma nova página para edição do projeto
  let { id } = useParams(); // "Pega" o id que está vindo pela URL
  ...
  useEffect(() => {
    //Pega os dados da API e coloca no project no useState
  ...
  function editPost(project) {
    //Irá editar os valores do projeto
  ...
  //Remove o serviço do projeto juntamente com seu custo e atualiza no banco de dados
